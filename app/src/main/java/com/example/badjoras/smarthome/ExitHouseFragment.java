 ...
 */
public class ExitHouseFragment extends Fragment {
    ...
    public static ExitHouseFragment newInstance(int position, String function, String title) {
        ExitHouseFragment f = new ExitHouseFragment();
        Bundle b = new Bundle();
